...
<div class="row justify-content-center mt-5">
    <a href="{{ route('gallery.create')}}" class="btn btn-primary float-end" style="margin-bottom: 30px;">Tambah
        Photo</a>
    <div class="col-md-8">
        <div class="card">
                        ...
                        <div>
                            <a class="example-image-link" href="{{asset('storage/posts_image/'.$gallery->picture )}}" data-lightbox="roadtrip"
                                ...
                                <img class="example-image img-fluid mb-2"
                                    src="{{asset('storage/resized_posts_image/'.$gallery->picture )}}" alt="image-1" />
                            </a>
                        </div>
                    </div>
                    @endforeach
